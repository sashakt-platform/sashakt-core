...
class TestRoleHierarchy:
    ...
    def test_get_valid_roles_super_admin(self):
    ...
    def test_get_valid_roles_system_admin(self):
    ...
    def test_get_valid_roles_state_admin(self):
    ...
    def test_can_assign_role_state_admin(self):
    ...
    def test_can_assign_role_test_admin(self):
    ...
    def test_can_assign_role_candidate(self):
    ...
    def test_can_assign_role_invalid_current_role(self):
    ...
    def test_can_assign_role_invalid_target_role(self):
