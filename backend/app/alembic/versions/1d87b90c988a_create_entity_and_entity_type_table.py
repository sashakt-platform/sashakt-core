...
def upgrade():
    ...
    op.create_table('candidate_test_profile',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('candidate_test_id', 'entity_id')
    )
    op.add_column('test', sa.Column('candidate_profile', sa.Boolean(), server_default='false', nullable=False))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('test', 'candidate_profile')
    op.drop_table('candidate_test_profile')
