...
Revision ID: aa9cdb105214
Revises:
Create Date: 2025-05-28 06:16:35.845826
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "phone", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column("role_id", sa.Integer(), nullable=False),
        sa.Column("organization_id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("identity", sa.Uuid(), nullable=True),
        sa.Column("created_date", sa.DateTime(), nullable=True),
        sa.Column("modified_date", sa.DateTime(), nullable=True),
        sa.Column("is_active", sa.Boolean(), nullable=True),
        sa.Column("is_deleted", sa.Boolean(), nullable=False),
    ...
    op.create_index(
        op.f("ix_candidate_identity"), "candidate", ["identity"], unique=True
    )
    op.create_table(
        "district",
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "marks_level",
            sa.Enum("QUESTION", "TEST", name="markslevelenum"),
            nullable=True,
        ),
        sa.Column("marks", sa.Integer(), nullable=True),
        sa.Column(
            "completion_message", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "start_instructions", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["question_revision_id"], ["question_revision.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["test_id"], ["test.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("modified_date", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
            ["candidate_test_id"], ["candidate_test.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["question_revision_id"], ["question_revision.id"], ondelete="CASCADE"
        ),
...
def downgrade():
    ...
    op.drop_index(op.f("ix_candidate_identity"), table_name="candidate")
